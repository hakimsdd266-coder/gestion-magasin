      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl overflow-hidden flex items-center justify-center shrink-0 bg-white/5">
              <img
                src={logo}
                alt="Hanouti"
            ...
            {/* Le nom de marque reste toujours Hanouti, même en arabe. */}
            <span className="heading text-lg">Hanouti</span>
          </div>
          ...
          <button
            ...
            className="px-4 py-2 rounded-full bg-white/5 border border-white/10 text-violet-200 text-xs hover:bg-white/10 transition-colors"
          >
        ...
        <div className="glass-panel p-7">
          ...
          {mode === 'login' ? (
            <p
              ...
              className="text-muted text-sm mb-6 animate-fade-slide"
            >
