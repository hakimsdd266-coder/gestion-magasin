      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-primary-from to-primary-to flex items-center justify-center shrink-0">
              <svg width="18" height="18" viewBox="0 0 100 100" fill="none">
                <path d="M28 44 L50 26 L72 44 Z" fill="white" />
                <rect x="34" y="44" width="9" height="26" fill="white" opacity="0.9" />
                <rect x="46" y="52" width="9" height="18" fill="white" opacity="0.75" />
                <rect x="58" y="38" width="9" height="32" fill="white" opacity="0.9" />
              </svg>
            </div>
            <span className="heading text-lg">
              {lang === 'ar' ? 'حانوتي' : 'Hanouti'}
            </span>
          </div>
          <button
