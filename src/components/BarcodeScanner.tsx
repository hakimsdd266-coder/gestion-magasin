...
// Limité aux formats réellement utilisés sur des produits de vente.
// Safari/iOS ne supporte pas l'API native BarcodeDetector (contrairement à
// Chrome/Android) donc le décodage se fait en JS pur (ZXing) sur iPhone —
// moins on lui demande de formats à tester par frame, plus c'est rapide.
// Remets CODE_128 / CODE_39 / CODABAR / ITF seulement si tu scannes
// vraiment des étiquettes logistique/entrepôt avec ces formats-là.
    ...
    html5Qrcode
      .start(
        { facingMode: 'environment' },
        {
          ...
          disableFlip: true,
          // Cap la résolution caméra : moins de pixels à décoder par frame
          // côté JS (surtout utile sur iOS, qui n'a pas le décodeur natif).
          // 'beta' côté librairie — si le flux caméra ne s'affiche pas
          // correctement sur un appareil, retire ce bloc sans problème.
          videoConstraints: {
            facingMode: 'environment',
            width: { ideal: 1280 },
            height: { ideal: 720 },
